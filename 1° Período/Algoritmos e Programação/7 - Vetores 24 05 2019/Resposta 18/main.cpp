...
int main()
{
    ...
    int vetor1[10],vetor2[10],vetord[10];
    int cont=0,repeat=0;
    ...
    while(cont<10){//Checando por igualdade entre todos os valores dos dos vetores
        ...
        while(repeat<10){
            ...
            if((repeat==9)&&(vetor1[cont]!=vetor2[repeat])){
                vetord[cont2]=vetor1[cont];
                cont2++;
                cout<<"\nNumero ("<<vetor1[cont]<<") esta em A mas nao em B";
                goto nextnumber3;
            }
            repeat++;
        }
    ...
    cout<<"\n";
    ///Ordena e printa elementos do vetor diferenca na tela
    sort(vetord,vetord+10);
    cont=0;
    cout<<"\n==========================================================\nVetor diferenca : \n\n";
        while(cont<10){
            if((vetord[cont]<101)&(vetord[cont]>0)){
                    cout<<"["<<vetord[cont]<<"] ";
            }
            cont++;
        }
