...
SIGNAL \u_MUX|Mux3~0_combout\ : std_logic;
SIGNAL \i_LOAD~input_o\ : std_logic;
SIGNAL \i_A[1]~input_o\ : std_logic;
SIGNAL \i_B[1]~input_o\ : std_logic;
SIGNAL \u_MUX|Mux2~1_combout\ : std_logic;
SIGNAL \u_MUX|Mux2~0_combout\ : std_logic;
SIGNAL \u_MUX|Mux2~2_combout\ : std_logic;
SIGNAL \u_ADDER|u_FULL_ADDER_1|o_CARRY_OUT~0_combout\ : std_logic;
SIGNAL \i_B[2]~input_o\ : std_logic;
SIGNAL \u_MUX|Mux3~1_combout\ : std_logic;
SIGNAL \i_A[2]~input_o\ : std_logic;
SIGNAL \u_MUX|Mux1~1_combout\ : std_logic;
SIGNAL \u_MUX|Mux1~0_combout\ : std_logic;
SIGNAL \u_MUX|Mux1~2_combout\ : std_logic;
SIGNAL \u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_2|o_R~combout\ : std_logic;
SIGNAL \u_MUX|Mux1~3_combout\ : std_logic;
SIGNAL \i_B[3]~input_o\ : std_logic;
SIGNAL \i_A[3]~input_o\ : std_logic;
SIGNAL \u_INCREMENTER|u_ADDER|u_FULL_ADDER_2|o_CARRY_OUT~0_combout\ : std_logic;
SIGNAL \u_MUX|Mux0~4_combout\ : std_logic;
SIGNAL \u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_3|o_R~0_combout\ : std_logic;
...
\u_MUX|Mux3~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux3~0_combout\ = ( \i_SEL[0]~input_o\ & ( \i_SEL[2]~input_o\ & ( (!\i_SEL[1]~input_o\ & ((\i_A[0]~input_o\) # (\i_B[0]~input_o\))) # (\i_SEL[1]~input_o\ & ((!\i_A[0]~input_o\))) ) ) ) # ( !\i_SEL[0]~input_o\ & ( \i_SEL[2]~input_o\ & ( 
...
\u_MUX|Mux2~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux2~1_combout\ = ( \i_SEL[0]~input_o\ & ( \i_B[1]~input_o\ & ( (!\i_A[1]~input_o\ & ((!\i_SEL[1]~input_o\) # (\i_SEL[2]~input_o\))) # (\i_A[1]~input_o\ & (!\i_SEL[2]~input_o\ $ (!\i_SEL[1]~input_o\))) ) ) ) # ( !\i_SEL[0]~input_o\ & ( 
...
PORT MAP (
	...
	combout => \u_MUX|Mux2~1_combout\);

-- Location: LABCELL_X88_Y37_N42
\u_MUX|Mux2~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux2~0_combout\ = ( \i_SEL[0]~input_o\ & ( \i_B[1]~input_o\ & ( (!\i_SEL[2]~input_o\ & (!\i_A[1]~input_o\ $ (((\i_SEL[1]~input_o\) # (\i_B[0]~input_o\))))) # (\i_SEL[2]~input_o\ & (((!\i_A[1]~input_o\) # (!\i_SEL[1]~input_o\)))) ) ) ) # ( 
...
PORT MAP (
	...
	datae => \ALT_INV_i_SEL[0]~input_o\,
	dataf => \ALT_INV_i_B[1]~input_o\,
	combout => \u_MUX|Mux2~0_combout\);

-- Location: LABCELL_X88_Y37_N9
\u_MUX|Mux2~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux2~2_combout\ = ( \i_A[0]~input_o\ & ( \u_MUX|Mux2~1_combout\ ) ) # ( !\i_A[0]~input_o\ & ( \u_MUX|Mux2~0_combout\ ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \u_MUX|ALT_INV_Mux2~1_combout\,
	datac => \u_MUX|ALT_INV_Mux2~0_combout\,
	datae => \ALT_INV_i_A[0]~input_o\,
	combout => \u_MUX|Mux2~2_combout\);

-- Location: FF_X88_Y37_N10
\u_REGISTER|o_R[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\u_ADDER|u_FULL_ADDER_1|o_CARRY_OUT~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_ADDER|u_FULL_ADDER_1|o_CARRY_OUT~0_combout\ = ( \i_B[1]~input_o\ & ( ((\i_A[0]~input_o\ & \i_B[0]~input_o\)) # (\i_A[1]~input_o\) ) ) # ( !\i_B[1]~input_o\ & ( (\i_A[0]~input_o\ & (\i_A[1]~input_o\ & \i_B[0]~input_o\)) ) )
...
PORT MAP (
	...
	dataf => \ALT_INV_i_B[1]~input_o\,
	combout => \u_ADDER|u_FULL_ADDER_1|o_CARRY_OUT~0_combout\);
...
\u_MUX|Mux3~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux3~1_combout\ = (!\i_SEL[1]~input_o\ & !\i_SEL[2]~input_o\)
...
\u_MUX|Mux1~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux1~1_combout\ = ( \i_A[2]~input_o\ & ( (\u_MUX|Mux3~1_combout\ & (!\i_SEL[0]~input_o\ & (!\u_ADDER|u_FULL_ADDER_1|o_CARRY_OUT~0_combout\ $ (\i_B[2]~input_o\)))) ) ) # ( !\i_A[2]~input_o\ & ( (\u_MUX|Mux3~1_combout\ & (!\i_SEL[0]~input_o\ & 
-- (!\u_ADDER|u_FULL_ADDER_1|o_CARRY_OUT~0_combout\ $ (!\i_B[2]~input_o\)))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \u_ADDER|u_FULL_ADDER_1|ALT_INV_o_CARRY_OUT~0_combout\,
	datab => \ALT_INV_i_B[2]~input_o\,
	datac => \u_MUX|ALT_INV_Mux3~1_combout\,
	datad => \ALT_INV_i_SEL[0]~input_o\,
	dataf => \ALT_INV_i_A[2]~input_o\,
	combout => \u_MUX|Mux1~1_combout\);

-- Location: LABCELL_X88_Y36_N12
\u_MUX|Mux1~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux1~0_combout\ = (!\i_SEL[1]~input_o\ & ((!\i_B[2]~input_o\ & (\i_A[2]~input_o\ & \i_SEL[0]~input_o\)) # (\i_B[2]~input_o\ & ((\i_SEL[0]~input_o\) # (\i_A[2]~input_o\))))) # (\i_SEL[1]~input_o\ & (!\i_A[2]~input_o\ $ (((!\i_B[2]~input_o\ & 
-- !\i_SEL[0]~input_o\)))))
...
PORT MAP (
	...
	datad => \ALT_INV_i_SEL[0]~input_o\,
	combout => \u_MUX|Mux1~0_combout\);

-- Location: LABCELL_X88_Y36_N36
\u_MUX|Mux1~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux1~2_combout\ = ( !\i_SEL[2]~input_o\ & ( \i_SEL[1]~input_o\ & ( !\i_A[2]~input_o\ $ (((!\i_A[1]~input_o\) # ((!\i_A[0]~input_o\) # (\i_SEL[0]~input_o\)))) ) ) )
...
PORT MAP (
	...
	combout => \u_MUX|Mux1~2_combout\);

-- Location: LABCELL_X88_Y36_N48
\u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_2|o_R\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_2|o_R~combout\ = ( \i_A[0]~input_o\ & ( \i_B[1]~input_o\ & ( !\i_B[2]~input_o\ $ (!\i_A[2]~input_o\ $ (!\i_A[1]~input_o\)) ) ) ) # ( !\i_A[0]~input_o\ & ( \i_B[1]~input_o\ & ( !\i_B[2]~input_o\ $ (!\i_A[2]~input_o\ $ 
-- (((!\i_A[1]~input_o\) # (\i_B[0]~input_o\)))) ) ) ) # ( \i_A[0]~input_o\ & ( !\i_B[1]~input_o\ & ( !\i_B[2]~input_o\ $ (!\i_A[2]~input_o\) ) ) ) # ( !\i_A[0]~input_o\ & ( !\i_B[1]~input_o\ & ( !\i_B[2]~input_o\ $ (!\i_A[2]~input_o\ $ (((\i_B[0]~input_o\ & 
-- !\i_A[1]~input_o\)))) ) ) )
...
PORT MAP (
	...
	datae => \ALT_INV_i_A[0]~input_o\,
	dataf => \ALT_INV_i_B[1]~input_o\,
	combout => \u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_2|o_R~combout\);

-- Location: LABCELL_X88_Y36_N6
\u_MUX|Mux1~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux1~3_combout\ = ( !\i_SEL[2]~input_o\ & ( (((\i_SEL[0]~input_o\ & (\u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_2|o_R~combout\ & !\i_SEL[1]~input_o\))) # (\u_MUX|Mux1~2_combout\)) # (\u_MUX|Mux1~1_combout\) ) ) # ( \i_SEL[2]~input_o\ & ( 
-- ((((\u_MUX|Mux1~2_combout\)) # (\u_MUX|Mux1~0_combout\))) # (\u_MUX|Mux1~1_combout\) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \u_MUX|ALT_INV_Mux1~1_combout\,
	datab => \ALT_INV_i_SEL[0]~input_o\,
	datac => \u_MUX|ALT_INV_Mux1~0_combout\,
	datad => \u_MUX|ALT_INV_Mux1~2_combout\,
	datae => \ALT_INV_i_SEL[2]~input_o\,
	dataf => \ALT_INV_i_SEL[1]~input_o\,
	datag => \u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_2|ALT_INV_o_R~combout\,
	combout => \u_MUX|Mux1~3_combout\);

-- Location: FF_X88_Y36_N7
\u_REGISTER|o_R[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\u_INCREMENTER|u_ADDER|u_FULL_ADDER_2|o_CARRY_OUT~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_INCREMENTER|u_ADDER|u_FULL_ADDER_2|o_CARRY_OUT~0_combout\ = (\i_A[0]~input_o\ & (\i_A[1]~input_o\ & \i_A[2]~input_o\))
...
PORT MAP (
	...
	datab => \ALT_INV_i_A[1]~input_o\,
	datac => \ALT_INV_i_A[2]~input_o\,
	combout => \u_INCREMENTER|u_ADDER|u_FULL_ADDER_2|o_CARRY_OUT~0_combout\);

-- Location: LABCELL_X88_Y36_N18
\u_MUX|Mux0~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux0~4_combout\ = ( \i_SEL[2]~input_o\ & ( \i_SEL[1]~input_o\ & ( !\i_A[3]~input_o\ $ (((!\i_B[3]~input_o\ & !\i_SEL[0]~input_o\))) ) ) ) # ( !\i_SEL[2]~input_o\ & ( \i_SEL[1]~input_o\ & ( !\i_A[3]~input_o\ $ 
-- (((!\u_INCREMENTER|u_ADDER|u_FULL_ADDER_2|o_CARRY_OUT~0_combout\) # (\i_SEL[0]~input_o\))) ) ) ) # ( \i_SEL[2]~input_o\ & ( !\i_SEL[1]~input_o\ & ( (!\i_B[3]~input_o\ & (\i_A[3]~input_o\ & \i_SEL[0]~input_o\)) # (\i_B[3]~input_o\ & ((\i_SEL[0]~input_o\) # 
-- (\i_A[3]~input_o\))) ) ) )
...
PORT MAP (
	...
	datac => \u_INCREMENTER|u_ADDER|u_FULL_ADDER_2|ALT_INV_o_CARRY_OUT~0_combout\,
	datad => \ALT_INV_i_SEL[0]~input_o\,
	datae => \ALT_INV_i_SEL[2]~input_o\,
	dataf => \ALT_INV_i_SEL[1]~input_o\,
	combout => \u_MUX|Mux0~4_combout\);

-- Location: LABCELL_X88_Y36_N42
\u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_3|o_R~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_3|o_R~0_combout\ = ( \i_A[0]~input_o\ & ( \i_B[1]~input_o\ & ( (!\i_B[2]~input_o\ & (!\i_A[2]~input_o\ & !\i_A[1]~input_o\)) # (\i_B[2]~input_o\ & ((!\i_A[2]~input_o\) # (!\i_A[1]~input_o\))) ) ) ) # ( !\i_A[0]~input_o\ 
-- & ( \i_B[1]~input_o\ & ( (!\i_B[2]~input_o\ & (!\i_A[2]~input_o\ & ((!\i_A[1]~input_o\) # (\i_B[0]~input_o\)))) # (\i_B[2]~input_o\ & (((!\i_A[2]~input_o\) # (!\i_A[1]~input_o\)) # (\i_B[0]~input_o\))) ) ) ) # ( \i_A[0]~input_o\ & ( !\i_B[1]~input_o\ & ( 
-- (\i_B[2]~input_o\ & !\i_A[2]~input_o\) ) ) ) # ( !\i_A[0]~input_o\ & ( !\i_B[1]~input_o\ & ( (!\i_B[2]~input_o\ & (\i_B[0]~input_o\ & (!\i_A[2]~input_o\ & !\i_A[1]~input_o\))) # (\i_B[2]~input_o\ & ((!\i_A[2]~input_o\) # ((\i_B[0]~input_o\ & 
-- !\i_A[1]~input_o\)))) ) ) )
...
PORT MAP (
	...
	datae => \ALT_INV_i_A[0]~input_o\,
	dataf => \ALT_INV_i_B[1]~input_o\,
	combout => \u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_3|o_R~0_combout\);

-- Location: LABCELL_X88_Y36_N30
\u_ADDER|u_FULL_ADDER_3|o_R\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_ADDER|u_FULL_ADDER_3|o_R~combout\ = ( \i_A[2]~input_o\ & ( !\i_B[3]~input_o\ $ (!\i_A[3]~input_o\ $ (((\i_B[2]~input_o\) # (\u_ADDER|u_FULL_ADDER_1|o_CARRY_OUT~0_combout\)))) ) ) # ( !\i_A[2]~input_o\ & ( !\i_B[3]~input_o\ $ (!\i_A[3]~input_o\ $ 
-- (((\u_ADDER|u_FULL_ADDER_1|o_CARRY_OUT~0_combout\ & \i_B[2]~input_o\)))) ) )
...
PORT MAP (
	...
	dataf => \ALT_INV_i_A[2]~input_o\,
	combout => \u_ADDER|u_FULL_ADDER_3|o_R~combout\);

-- Location: LABCELL_X88_Y36_N0
\u_MUX|Mux0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \u_MUX|Mux0~0_combout\ = ( !\i_SEL[0]~input_o\ & ( (((\u_ADDER|u_FULL_ADDER_3|o_R~combout\ & ((\u_MUX|Mux3~1_combout\))))) # (\u_MUX|Mux0~4_combout\) ) ) # ( \i_SEL[0]~input_o\ & ( ((\u_MUX|Mux3~1_combout\ & (!\i_A[3]~input_o\ $ (!\i_B[3]~input_o\ $ 
-- (\u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_3|o_R~0_combout\))))) # (\u_MUX|Mux0~4_combout\) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \u_MUX|ALT_INV_Mux0~4_combout\,
	datab => \ALT_INV_i_A[3]~input_o\,
	datac => \ALT_INV_i_B[3]~input_o\,
	datad => \u_SUBTRACTOR|u_ADDER|u_FULL_ADDER_3|ALT_INV_o_R~0_combout\,
	datae => \ALT_INV_i_SEL[0]~input_o\,
	dataf => \u_MUX|ALT_INV_Mux3~1_combout\,
	datag => \u_ADDER|u_FULL_ADDER_3|ALT_INV_o_R~combout\,
	combout => \u_MUX|Mux0~0_combout\);

-- Location: FF_X88_Y36_N1
\u_REGISTER|o_R[3]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
